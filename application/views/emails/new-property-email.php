...
<p><strong style="color:#b4151b">From:</strong> <?php echo $agent_name." at ".$agency_name ?></p>
<p><strong style="color:#b4151b">Property Address:</strong> <?php echo $mail_prop_address; ?></p>
<hr/>
