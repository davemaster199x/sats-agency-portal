                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td style="padding: 25px 25px;text-align:left;background:#fff;">
                                                            <a href="https://<?php echo config_item('base_domain') ?>">
																<img  style="width: 260px;" src="<?php echo theme('/images/login_logo.png'); ?>" alt="<?= $this->config->item('COMPANY_FULL_NAME') ?>">
															</a>
                                                        </td>
