...
// add template
    ...
    function parseEmailTemplateTags($params, $body) {
        ...
        if ($params['agency_id'] != '') { // agency
        ...
        }else if ($params['aua_id'] != '') { // agency staff user	
            ...
            $find = array('{agency_staff_fname}','{agency_staff_2fa_code}','{agency_staff_device_used}','{agency_staff_browser_used}','{agency_staff_ip}','{agent_number}','{info_sats_email}');
            $replace = array($agency_staff_fname, $agency_staff_2fa_code, $agency_staff_device_used, $agency_staff_browser_used, $agency_staff_ip,$ctn['agent_number'],make_email('info'));

            //$subject_fin = str_replace($find, $search, $subject);
            $message_fin = str_replace($find, $replace, $body);
